...
def negative_assert_symbol(first_name):
    ...
    expected_message = "Имя пользователя введено некорректно. " \
                       "Имя может содержать только русские или латинские буквы, " \
                       "длина должна быть не менее 2 и не более 15 символов"
    assert user_response.json()["message"] == expected_message
...
# Тест 3. Ошибка. Негатвный кейс создание пользователя (Количество символов меньше допустимого (1)).
...
# Тест 4. Ошибка. Негатвный кейс создание пользователя (Количество символов меньше допустимого (16)).
...
# Тест 7. Ошибка. Негатвный кейс создание пользователя (Запрещены пробелы).
...
# Тест 8. Ошибка. Негатвный кейс создание пользователя (спецсимволы).
...
# Тест 9. Ошибка. Негатвный кейс создание пользователя (цифры).
...
def test_create_user_empty_first_name_get_error_response():
    # В переменную user_body копируется значение user_body из файла data
    user_body = data.user_body.copy()
    # В user_body меняем значение firstName на ""
    user_body["firstName"] = ""
    # Проверка полученного ответа
    negative_assert_no_first_name(user_body)
